...
PROVIDER_PAGES = (
    {
        ...
        "keys": ("magnum",),
        "context": "Check the Magnum 4D (Magnum4D) numbers for the displayed draw. Read each prize heading with its number, then match the draw date and draw number.",
        ...
        "verification": "Before relying on a Magnum result, compare the draw date, draw number and prize category with the provider's published result. 4DVIP88 is an independent reference site, not an official Magnum source.",
    ...
    },
    {
        ...
        "keys": ("toto", "totoextra"),
        "context": "Sports Toto (SportsToto) results use separate cards for 4D and the other games listed here. Check the game label before reading a number.",
        ...
        "verification": "To verify a Sports Toto result, match the game name, draw date, draw number and numbers with the provider's published result. Check prize and claim information directly with the provider.",
        "related_href": "/west-malaysia-4d-results/",
        "related_label": "Compare the current West Malaysia provider results",
    },
    {
        ...
        "context": "Da Ma Cai (Damacai) results appear in two labelled cards. Use each card's heading and prize group when checking the displayed numbers.",
        ...
        "verification": "To verify a Da Ma Cai result, match the draw date, draw number and prize group with the provider's published result. Use the 4D or 1+3D labels to keep each card's numbers in the correct context.",
        "related_href": "/west-malaysia-4d-results/",
        "related_label": "Compare the current West Malaysia provider results",
    },
    {
    ...
    },
    {
        ...
        "keys": ("sandakan",),
        "context": "This page shows the Sandakan Turf Club result, labelled STC.",
        "coverage": "The Sandakan Turf Club card contains the top-three, special and consolation numbers for the displayed STC draw. Check the date and draw number above the prizes to make sure you are reading the result you need.",
...
REGION_PAGES = (
    {
        ...
        "verification": "Verify Magnum, Sports Toto and Da Ma Cai results separately. Match each card's draw date, draw number and prize labels with the relevant provider's published result before relying on the numbers shown here.",
